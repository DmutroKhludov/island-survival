...
function makeAxeModel() {
  ...
  bladeMesh.position.set(-0.02, 0.28, 0);
...
const AXE_BASE_ROT = { x: 0.1, y: -0.2, z: 0.1 };
const AXE_BASE_POS = { x: 0.21, y: -0.16, z: -0.56 };
...
function updateHeld() {
  ...
  heldGroup.position.set(AXE_BASE_POS.x + sway - chop * 0.16,
                         AXE_BASE_POS.y + bob + chop * 0.1,
                         AXE_BASE_POS.z + chop * 0.05);
  heldAxe.rotation.set(AXE_BASE_ROT.x + chop * 0.55,
                       AXE_BASE_ROT.y + chop * 0.2,
                       AXE_BASE_ROT.z - chop * 0.95);
}
